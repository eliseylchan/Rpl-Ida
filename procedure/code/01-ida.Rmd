...
```{r setup-no-groundhog, warning = FALSE}
# load and install required packages
...
I collaborated with [Andy Cao](https://andreyjcao.github.io/) on this project.
See his project on his Github site for a different take on this replication.
